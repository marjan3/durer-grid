package com.mtanevski.art.durer.grid.components.grid;
...
import static com.mtanevski.art.durer.grid.DefaultValues.MIN_INCREMENT;
...
public class Grid extends Pane {
    ...
    private void drawGridAsync(double newValue) {
        Platform.runLater(() -> {
            ...
            drawGridLines(Math.max(newValue, MIN_INCREMENT));
            drawCenterLines();
        });
    }
