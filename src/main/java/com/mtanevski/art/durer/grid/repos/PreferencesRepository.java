...
import static com.mtanevski.art.durer.grid.utils.FxUtil.toHexString;
...
public class PreferencesRepository {
    ...
    public static Color getFrameColor() {
        return Color.valueOf(PREFERENCES.get(FRAME_COLOR, toHexString(DefaultValues.FRAME_COLOR)));
    }

    public static void setFrameColor(Color value) {
        PREFERENCES.put(HEIGHT, toHexString(value));
    }

    public static Color getGridLinesColor() {
        return Color.valueOf(PREFERENCES.get(GRID_LINES_COLOR, toHexString(DefaultValues.GRID_LINES_COLOR)));
    }

    public static void setGridLinesColor(Color value) {
        PREFERENCES.put(GRID_LINES_COLOR, toHexString(value));
    }

    public static Color getCenterLinesColor() {
        return Color.valueOf(PREFERENCES.get(CENTER_LINES_COLOR, toHexString(DefaultValues.CENTER_LINES_COLOR)));
    }

    public static void setCenterLinesColor(Color value) {
        PREFERENCES.put(CENTER_LINES_COLOR, toHexString(value));
    }
