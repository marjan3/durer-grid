...
public class Resizer {
    ...
    private static Property<Integer> width;
    private static Property<Integer> height;
    private static RootContainer rootContainer;

    public static void addResizeListener(Stage stage, Property<Integer> width, Property<Integer> height) {
        Resizer.width = width;
        Resizer.height = height;
        rootContainer = (RootContainer)stage.getScene().getRoot();
        int frameLengthBothSides = (int) rootContainer.getFrameLength() * 2;
        addResizeListener(stage,
                DefaultValues.MIN_WIDTH + frameLengthBothSides,
                DefaultValues.MIN_HEIGHT + frameLengthBothSides,
                Double.MAX_VALUE,
                Double.MAX_VALUE);
    }
    ...
    static class ResizeListener implements EventHandler<MouseEvent> {
        ...
        private final int border = DefaultValues.RESIZE_BORDER;
        ...
        private void setStageWidth(double width) {
            ...
            Resizer.width.setValue((int)width - (int)(rootContainer.getFrameLength() * 2));
        }

        private void setStageHeight(double height) {
            height = Math.min(height, maxHeight);
            height = Math.max(height, minHeight);
            Resizer.height.setValue((int)height - (int)(rootContainer.getFrameLength() * 2));
        }
